  ...
  return (
    <div className=" rounded-lg bg-slate-900 h-130 p-4 ">
      <div className="max-w-2xl mx-auto">
        ...
        <div className=" rounded-2xl border border-gray-200 shadow-sm  h-90  p-6">
            ...
            {!isEditing ? (
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex items-center gap-3 px-4 py-2 bg-white- hover:bg-red-500  hover:text-white  hover:border-2  text-white rounded-lg w-38 h-12 border border-gray-600  text-sm font-semibold transition-all cursor-pointer"
                >
                  <X size={14} /> Cancel
                </button>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full border-2 rounded-xl py-3 pl-11 pr-4 text-sm font-semibold outline-none transition-all
                    ${
                      !isEditing
                        ? "bg-gray-50 border-gray-100 text-black cursor-not-allowed"
                        : errors.fullName
