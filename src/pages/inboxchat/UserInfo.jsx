                ...
                <div className="flex-1 overflow-y-auto px-6 py-8">
                    ...
                    <div className="flex flex-col items-center">
                        <div className="relative">
                            <div className="w-32 h-32 rounded-full bg-white border borderslate-400 flex items-center justify-center text-black text-4xl font-bold border-4 border-[#111827]">
                                EL
                            </div>
                    ...
                    <div className="mt-10 space-y-5">
                        ...
                        {/* FIELD 5 — Tags */}
                        <div className="group bg-white/[0.03] border flex  border-white/10 rounded-3xl px-5 py-4 hover:border-teal-400 transition-all duration-300">
                            <label className="flex items-center gap-2 text-xs uppercase tracking-[2px] text-slate-400 mb-3">
                            ...
                            {/* <input
                                ...
                                className="w-full bg-transparent outline-none text-white text-base placeholder:text-slate-500"
                            /> */}
                            <button className=" bg-blue-200 p-2  rounded-md  text-blue-800 border  border-blue-300 ">
                                <Plus
