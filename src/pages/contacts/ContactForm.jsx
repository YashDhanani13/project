                ...
                <div className="px-8 py-7">
                    ...
                    >
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div
                                className={`flex items-center gap-2.5 rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-blue-500/40 ${errors.name ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-blue-500/70 hover:border-slate-600'}`}
                            >
                                <User
                                    size={14}
                                    className={
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div
                                className={`flex items-center gap-2.5 rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-blue-500/40 ${errors.email ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-blue-500/70 hover:border-slate-600'}`}
                            >
                                <Mail
                                    size={14}
                                    className={
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div
                                    className={`flex items-center gap-2.5 rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-blue-500/40 ${errors.age ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-blue-500/70 hover:border-slate-600'}`}
                                >
                                    <Hash
                                        size={14}
                                        className={
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div
                                    className={`relative flex items-center rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-blue-500/40 ${errors.tag ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-blue-500/70 hover:border-slate-600'}`}
                                >
                                    <select
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div
                                className={`flex items-center gap-2.5 rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-blue-500/40 ${errors.phoneNumber ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-blue-500/70 hover:border-slate-600'}`}
                            >
                                <Phone
                                    size={14}
                                    className={
                        ...
                        <div className="space-y-1.5">
                            ...
                            >
                                <MapPin
                                    size={14}
                                    className={`mt-0.5 ${errors.address ? 'text-red-400 shrink-0' : 'text-slate-500 shrink-0'}`}
                                />
                                <textarea
                                    rows={3}
