    ...
    return (
        <div className="min-h-screen bg-slate-900 text-slate-100 p-6">
            ...
            <div className="flex items-center gap-2  mb-6 flex-wrap">
                ...
                <div className="flex flex-1 max-w-2xl items-center gap-2.5 font-serif   rounded-xl border border-amber-700 bg-slate-800 font-bold px-3 py-4 focus-within:border-gray-400  border-2 hover:border-slate-600 ">
                ...
                <>
                    ...
                    <div className="bg-slate-800 border border-slate-700 rounded-md shadow-xl overflow-hidden">
                        ...
                        <div className="px-5 py-3 border-t border-slate-700 flex items-center justify-between flex-wrap gap-3 bg-slate-900/40">
                            ...
                            <div className="flex items-center  font-serif gap-2 text-xs text-slate-400">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button
                                    ...
                                    className=" p-3  w-30 rounded-lg border border-slate-600  text-slate-300 text-xs font-serif disabled:opacity-30 hover:bg-white  transition-all  ease-in-out delay-200 hover:text-green-500 hover:border-green-600 disabled:bg-red-200 disabled:border-red-600 disabled:text-red-400 isabled:cursor-not-allowed cursor-pointer"
                                >
                                    Next →
                                </button>
                            </div>
