...
//       <div className="flex items-center w-40 justify-between gap-4 animate-pulse">
       
//         {/* Search Bar Skeleton */}
//         <div className="flex-1 h-10 w-60  bg-gray-100 rounded-md border border-gray-200"></div>

//         {/* Add Employee  Button Skeleton */}
...
//               <th className="p-4 text-white font-medium">Role</th>
//               <th className="p-4 text-white font-medium">Tags</th>
//               <th className="p-4 text-white font-medium">Phone</th>
