            ...
            <div className="w-full max-w-120 rounded-t-lg bg-slate-800 border border-gray-700 rounded-xl shadow-2xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-gray-800 to-mist-700    px-8 py-4 flex  rounded-t-lg items-center justify-between border border-black ">
                    <div>
                        ...
                        <p className="text-gray-500  text-md mt-0.5 opacity-80">
                ...
                <div className="px-8 py-7 space-y-5">
                    ...
                    >
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div
                                className={`flex items-center gap-2.5 rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-orange-500/40 ${errors.email ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 over:border-slate-600'}`}
                            >
                                <Mail
                                    size={14}
                                    className={
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div
                                    className={`relative flex items-center rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-orange-500/40 ${errors.role ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-orange-500/70 hover:border-slate-600'}`}
                                >
                                    <select
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div
                                    className={`relative flex items-center rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-orange-500/40 ${errors.status ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-orange-500/70 hover:border-slate-600'}`}
                                >
                                    <select
                                        className="w-full bg-transparent text-sm text-slate-100 outline-none appearance-none pr-5 cursor-pointer"
                                        {...register('status')}
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div
                                className={`flex items-center gap-2.5 rounded-xl border bg-slate-900/60 px-3 py-2.5 transition-colors focus-within:ring-2 focus-within:ring-orange-500/40 ${errors.phoneNumber ? 'border-red-500/60 focus-within:border-red-500' : 'border-slate-700 focus-within:border-orange-500/70 hover:border-slate-600'}`}
                            >
                                <Phone
                                    size={14}
                                    className={
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="flex items-center gap-2 px-4 py-2 bg-white  text-black border border-black border-2 hover:bg-black hover:text-white hover:border-indigo-500 hover:border-2  rounded-lg w-47 h-12  text-sm font-semibold  cursor-pointer transition-all"
                            >
                                {loading ? (
                                    <Loader2
                                        size={15}
