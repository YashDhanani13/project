...
const ContactSidebar = ({
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put(
        `${import.meta.env.VITE_API_URL || "http://localhost:3000"}/api/contacts/${selectedContact.id}`,
        updatedContact
      );
      setIsEditing(false);
        ...
        {isEditing ? (
          ...
          <div>
            ...
            <div className="bg-gray-50 p-3 rounded-lg">
              ...
              <p className="font-semibold text-gray-800">{selectedContact.address}</p>
            </div>
            ...
            <div className="flex gap-2">
              ...
              >✏️ Edit</button>
              <button
                onClick={(e) => { e.stopPropagation(); handleDelete(selectedContact.id); }}
